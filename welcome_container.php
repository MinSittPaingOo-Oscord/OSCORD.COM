...
<style>
    ...
    .welcome-slide:nth-child(6) { background-image: url('./image/wel5b.png'); }
    .welcome-slide:nth-child(7) { background-image: url('./image/wel6.png'); }
    .welcome-slide:nth-child(8) { background-image: url('./image/wel7.png'); }
    .welcome-slide:nth-child(9) { background-image: url('./image/wel8.png'); }
    ...
    @media (max-width: 767px) {
      ...
      .welcome-slide:nth-child(9) { background-image: url('./image/phone9.png'); }
...
<div id="welcomeCarousel">
  ...
  <div id="welcomeIndicators">
    ...
    <span class="welcome-dot" onclick="welcomeCurrentSlide(8)"></span>
