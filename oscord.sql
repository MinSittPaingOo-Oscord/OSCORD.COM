...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2026 at 08:32 PM
...
CREATE TABLE `batch` (
  ...
  `classSchedule` longtext NOT NULL,
...
INSERT INTO `batch` (`batchID`, `courseID`, `batchNumber`, `startDate`, `classSchedule`, `status`, `seatAvailable`, `expectedEndDate`) VALUES
(4, 9, 4, '2026-02-21', 'Every Monday to Wednesday\r\n8:00 pm to 9:00 pm (Myanmar Time)', 'Coming Soon', 15, '2026-08-21'),
(5, 30, 1, '2026-02-01', 'Every Monday to Wednesday\r\n6:00 pm to 7:30 pm (Myanmar Time)', 'In Progress ', 0, '2026-05-31'),
(7, 1, 8, '2026-02-28', 'Every Sat + Sun\r\n7:30 pm to 9:00 pm(Myanmar Time)', 'Coming Soon', 15, '2026-06-30'),
(8, 9, 3, '2025-12-12', 'Every Sat + Sun\r\n7:00 pm to 8:00 pm (Myanmar Time)', 'In Progress', 0, '2026-04-13');
...
--
-- Table structure for table `learningtype`
--

CREATE TABLE `learningtype` (
  `typeID` int NOT NULL,
  `typeName` varchar(10000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `learningtype`
--

INSERT INTO `learningtype` (`typeID`, `typeName`) VALUES
...
CREATE TABLE `lecture_link` (
  `linkID` int NOT NULL,
  `linkName` varchar(2000) NOT NULL,
...
INSERT INTO `lecture_link` (`linkID`, `linkName`, `link`, `courseID`) VALUES
(1, 'Database System & Design', 'https://docs.google.com/document/d/1lKud24Lr5OkkE2vqsOcTxxRn3nFnhIgojggwJTm45zs/edit?usp=sharing', 9),
(2, 'Database Systems & Design', 'https://docs.google.com/document/d/1lKud24Lr5OkkE2vqsOcTxxRn3nFnhIgojggwJTm45zs/edit?usp=sharing', 3),
(3, 'PHP Programming', 'https://docs.google.com/document/d/1XLfi62yUM4vc5hXhGd5KRYeu-1m51hYLWT046tK73Yc/edit?usp=sharing', 9),
(4, 'PHP Programming', 'https://docs.google.com/document/d/1XLfi62yUM4vc5hXhGd5KRYeu-1m51hYLWT046tK73Yc/edit?usp=sharing', 5);
...
CREATE TABLE `oscord_course` (
  ...
  `courseDescription` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
(1, 'Java Programming (Basic to Advanced)', 'Kick off your Java programming adventure with our engaging course! Master core Java (J2SE) to craft robust programs, design sleek user interfaces with Java Swing, and build a real-world CRUD (Create, Read, Update, Delete) project using MySQL. Through hands-on projects, you’ll gain skills to develop dynamic applications and for creating your own software.', '500,000 MMK', '4 months to 5 months', 'https://www.facebook.com/share/p/1FaCuNq5Ry/', 1, 'java.png'),
(2, 'Python Programming (Basic to Advanced)', 'Python  Programming ကို အခြေခံ Basic Syntax တွေကစပြီး  Database MY SQL သာမက MongoBD တိုကိုလည်းသုံးပြီး  CURD  Project တွေရေးနိုင်သည်အထိ သင်ယူရမဲ့  Oscord Code Academy ရဲ့ Python Programming (Basic to Master) Class ဒီအတန်းရဲ့ အဆုံးတွင် CRUD မှာတင်ရပ်သွားမှာမဟုတ်ဘဲ Final Project အနေဖြင့် Software Development ရဲ့ ရူပ်ထွေးတယ်လို လူသိများတဲ့ Backend System တစ်ခုကို သေချာစွာ Develop လုပ်နိုင်စေဖို POS application တစ်ခုကိုဆရာနဲ့ အတူတူဖန်တီးသွားမှာဖြစ်ပါတယ်', '500,000 MMK', '4 months to 5 months', 'https://www.facebook.com/share/p/1BqQw7hadQ/', 2, 'python.png'),
(3, 'Database Systems and Design(MY SQL)', 'Learn how the database management system works , how to design a physical database starting from Conceptual database design and Logical database design, using it in application', '230,000 MMK', '3 months', 'https://www.facebook.com/share/p/1KHJnBkWwA/', 5, 'database.png'),
(4, 'Frontend Web Development', 'Kickstart your front-end web development journey with our beginner-friendly course! Learn to create stunning, interactive websites using HTML, CSS, Bootstrap and JavaScript. Through hands-on projects, you’ll build responsive web pages that shine on any device, gaining skills to launch a tech career or bring your ideas to life. All you need is basic computer knowledge and a passion for design!', '290,000 MMK', '3 months', 'https://www.facebook.com/share/p/179GHoiCVL/', NULL, 'frontend.png'),
(5, 'Backend Web Development', 'Launch your backend web development career with our beginner-friendly course! Learn to build powerful, secure server-side applications using tools like PHP and databases like MY SQL. Through hands-on projects, you’ll  manage data to power dynamic websites, gaining skills for a tech job or your own projects. As for the requirement you will need frontend web skills and a curiosity for how websites work behind the scenes!', '330,000 MMK', '3 months', 'https://www.facebook.com/share/p/179GHoiCVL/', NULL, 'backend.png'),
(6, 'Desktop Application Developmet with C#.Net', 'Join Our C#.NET Fundamentals Course!  Master C# programming from scratch and build practical desktop apps for businesses, like POS or inventory systems, in just 3-4 months! With one-on-one Zoom or in-person classes, hands-on projects, this course is perfect for beginners and aspiring developers.', '390,000 MMK', '3 months to 4 months', 'https://www.facebook.com/share/p/1AQNx1RBEt/', 6, 'chref.png'),
(7, 'C Programming', 'Learning programming with C from basic easily and focusing on basic programming concepts', '250,000 MMK', '3 months', 'https://www.facebook.com/share/p/1D5W1k541w/', NULL, 'c.png'),
...
(9, 'Full Stack Web Developer Class', 'Web Development ကို စိတ်ဝင်စားတဲ့သူတိုင်းအတွက် အခြေခံ Frontend Level ကနေစပြီး လုပ်ငန်းခွင်မှာ တကယ်အသုံးဝင်တဲ့ Backend Development နဲ့ Database တွေအထိ လက်တွေ့ကျကျ ရေးသားနိုင်အောင် သင်ပေးသွားမှာပါ။ Code Theory တွေကအစ လက်တွေ့ Project တွေထိ အကုန်ပါဝင်မှာဖြစ်ပါတယ်။ Website တစ်ခုကို Internet ပေါ်မှာ ကိုယ်ပိုင် Domain နှင့်တင်နိုင်တဲ့အထိ သင်ပြသွားမှာဖြစ်ပါတယ်  Final Project မှာ ကိုယ်စိတ်ကြိုက် LMS, Ecommerence, POS system စသဖြင့် ကြိုက်တဲ့ Web Project တစ်ခုကို ဆရာနဲ့အတူ အစအဆုံး ရေးသားရမှာ ဖြစ်ပြီး၊ Project မစခင် ဆရာက နမူနာတစ်ခုကို အရင်ဆုံး သင်ပြပေးသွားမှာပါ', '600,000 MMK', '6 months', 'https://www.facebook.com/share/p/179GHoiCVL/', 3, 'fullStack.png'),
(28, 'Data Structure and algorithms', 'Explore coding with our beginner-friendly Data Structures and Algorithms course! Learn to organize data, solve problems, and write efficient code through hands-on projects. Perfect for landing tech jobs or acing coding interviews. All you need is basic programming knowledge!', '270,000 MMK', '3 months', 'https://web.facebook.com/permalink.php?story_fbid=pfbid02mUS2Vn7ABUoaYEp6pnPrxbcaZaJoJxJ1UoTSKorxisBVp5SzWiiE1a3vuPCF58fl&id=100088520077343', 5, 'dsa.png'),
...
(14, 'Database Systems and Design foundation', 1),
(15, 'CRUD Project with Java', 1),
(16, 'POS System Development with Java', 1),
...
(41, 'Final Backend Application Project', 3),
(42, 'HTML', 4),
(43, 'CSS', 4),
(44, 'JavaScript', 4),
(45, 'Bootstrap', 4),
(46, 'Frontend Web Project', 4),
(47, 'Database Design & Systems (MY SQL)', 5),
(48, 'PHP Programming (Basic to Advanced)', 5),
(49, 'Simple CRUD backend project', 5),
(50, 'Introduction to Laravel Framework', 5),
(51, 'Final Web Application Project', 5),
(61, 'Complete C# Fundamental Course', 6),
...
(115, 'Database Systems and Design Foundation', 2),
...
(203, 'CRUD Project with Database MYSQL', 2),
(204, 'CRUD Project with MongoDB NoSQL', 2),
(205, 'POS System Development with Python', 2);
...
(12, 'Min Sitt Paing Oo', 'minsitt.p67@rsu.ac.th', '$2y$10$JFRNzEuByXBDKXDh8cSTb.AyoUTk99ApZlk0AzamSqh/sY88q3zaO', 1, '2004-06-30', '0823059272', 198989),
...
(18, 'Swe Swe Win', 'umwswewin@gmail.com', '$2y$10$6m6cizS9KzNuDOmpaabn2OyZIQQc7n0cb1BCXQwlvmNpK65KleUh6', 0, '1989-11-03', '09455604253', 778899);
...
INSERT INTO `oscord_student` (`studentID`, `studentName`, `studentCountry`, `studentBirthday`, `studentEmail`, `studentPassword`, `studentTelegram`, `studentPhone`, `studentApprove`, `question1`, `question2`, `registrationDate`, `learningType`) VALUES
(10, 'Aeint', 'Myanmar', '2005-04-10', 'aeintthinzarzawmyint@gmail.com', '$2y$10$OR7K/U3EdP/BOcbx7vsGqOCa9UQkq1wKXwFYgslF/mJfMVIEMg7Hq', '@n_iaeintmm', '09408811141', 1, 'No', 'I want to be a software developer', '2025-05-28', 2),
(15, 'Phyu Phyu Thant', 'Myanmar', '2004-09-29', 'phyuphyut119@gmail.com', '$2y$10$kEpauazSkHHm0FYnxPrfFukUWt5AMTxZRSR9vqn4MYgL.T1Rw3dyG', '@t92nt', '09886058500', 1, 'Java & web development course', 'Aimed to understand the basic knowledge in computer science.', '2025-06-12', 2),
(16, 'NAING NINE', 'Japan', '2002-05-25', 'naingosaka121212@gmail.com', '$2y$10$9.5xgNBS4nr6c6.gTMHm/uoWAkUkWNTiQ1Nh/mMONe5BA/IAtD5Am', 'eccnn9898', '07091423223', 0, 'No', 'I’m going to an IT college next year.', '2025-06-14', 2),
(17, 'Merry Moe', 'Thailand', '1984-01-13', 'merrymoe345@gmail.com', '$2y$10$CTtp2X.F/aQc0KnODzs5Ju5.0RjHqRlHEjzD/o/hXs1wtnr7itypG', '@merrymoe', '9952090401', 1, 'No', 'For my job', '2025-06-14', 2),
(18, 'Naw The\' Phyu', 'Thailand', '1994-02-14', 'nawthephyu@gmail.com', '$2y$10$OFxjZtRj5Jj8IaMFU.WVwejJw47/MCaU4UZcp5zirLwhXQ8LPdY22', '@Charoen_Rasamee', '+66613607287', 1, 'No experience of learning the program', 'I intent to create or build up the pharamacy database and application for pharmacy management system of my organization.', '2025-06-14', 2),
(19, 'Phoo Myat Thwe', 'Myanmar', '2004-06-14', 'phoomyatthwe@gmail.com', '$2y$10$Po4ZFqJqSL4AzgBG7K8GR.9OeRvD.cTitNE/r4gWlMosDHQUJJfR6', '@H_ffe9ef', '09778654804', 1, 'I used to learn C Programming', 'I am interested in software engineering I guess. Programming is a part of it and another fact is I like to code.', '2025-06-14', 2),
(20, 'Janet', 'Sweden', '1996-09-06', 'nawjanet16@gmail.com', '$2y$10$w4kGsEvF0tLFk/lrnbNM/uEsSetwmMuyjvmh7zeLzF0yh4esw3HzG', 'NJ', '+46733620774', 1, 'Java basic', 'For career change', '2025-06-14', 2),
(21, 'Phyo Zin May', 'Japan', '1996-01-15', 'phyozinmay@gmail.com', '$2y$10$LVKCg6moivg0J/4RogZVleq3qu29OlKeb2OtYpLIpHHs8V8.xQmiK', '@Snowie_e', '+959250269248', 1, 'No experience about learning java', 'Because want to get job', '2025-06-15', 2),
(22, 'San Lin Bay', 'Thailand', '1995-06-15', 'sanlinbay@gmail.com', '$2y$10$KoKC6Gdw7YGXCIR6Wo2qoONbyxljlDX8bfmaxGcDTBgdsp8kQWQO6', '@Sanlinbay', '0656506242', 1, 'Never learned program before', 'To improve my IT skill. To promote my skills working with organization. Because I interest in IT programing.', '2025-06-15', 2),
(23, 'Nyi Nyi Htet', 'Singapore', '1988-06-15', 'nyinyihtet@gmail.com', '$2y$10$QohiVYZ4XjRfg/gEvOXbkOCDXtaovmNfPCpi2S7cDASWM8EZnnfay', '@nyinyihtet', '+6581618011', 1, 'No', 'Interested in Programming', '2025-06-15', 2),
(24, 'Hein Htet', 'Singapore', '1998-02-15', 'heinhtet@gmail.com', '$2y$10$pvFSLq2LF8jc65FbWxl7keYgnmT1NHPkGuE5WB0YVI5rddurEjYyO', '@henry845879', '+66824762618', 1, 'No', 'Interested and Want to try', '2025-06-15', 2),
(25, 'Phoo Myat Thwe', 'Myanmar', '2004-06-15', 'phoomyatthwe@gmail.com', '$2y$10$jLoimAswxCcA0tt32Mo75OY0UsLApONF7ardePExYr47XFyJ8RHMS', '@H_ffe9ef', '09778654804', 1, 'I used to learn C Programming', 'I am interested in software engineering I guess. Programming is a part of it and another fact is I like to code.', '2025-06-15', 2),
(26, 'Nay Lin Thar', 'Myanmar', '1998-06-10', 'naylinthar@gmail.com', '$2y$10$Z2USUVsB9ukyUjxV8iODGO1F/D45v4KGEuBkdaQhDgdIQDGUwb4wy', '@ellegigle', '09785925304', 1, 'No', 'Because I am interested', '2025-06-15', 2),
(27, 'Nan May OO Myint', 'Singapore', '1990-06-15', 'naymayoomyint@gmail.com', '$2y$10$665I1P8ZBm5IPPHT0jmW4.bgnxzNNQUpyXgqJChpp0iR.bpPaqP42', '@nanmayoomyint', '+6591455714', 1, 'Totally Zero', 'wanna learn about the coding and recommended by friend', '2025-06-15', 2),
(28, 'So Pyay', 'Singapore', '1990-06-22', 'sopyay@gmail.com', '$2y$10$eLXm0hyrzB0FyJOQAZRpUugRm/k1jR7LYi8bFYEcVMWGequBE0aSG', '@sopyay', '+6598613482', 1, 'No', 'Application for script programming automation machines', '2025-06-15', 2),
(29, 'Zayar Oo', 'Singapore', '1979-06-18', 'zayaroo@gmail.com', '$2y$10$RlKD7Y1S03zEMnAs9a15JO3q.3puJfe.ecBnWC4Ts9XScenvN6/6y', '@zayaroo', '+6597247756', 1, 'not learn before programming.', 'null', '2025-06-15', 2),
(30, 'Thaw Zin Latt', 'Myanmar', '2008-06-15', 'thawzinlatt@gmail.com', '$2y$10$SWfe3YE3sLzfQBhqpS8Fs.TCkJuldbas2WPd7OlyohFQQRCtDd53e', '@thawzinlatt', '+959967993562', 1, 'Programming not learn before', 'null', '2025-06-15', 2),
(31, 'Pyae Hein', 'Kuweit', '1984-02-15', 'pyaehein@gmail.com', '$2y$10$6gzCqOxRfoMzECby8ANfXu4PuZQOj4ka5xxNxZQ/65bQslYCLma7W', '@pyaehein', '+96596645418', 1, 'Programming အတန်းတွေ တက်ဖူးပါတယ်။ Group အတန်းတွေမှာ စာမလိုက်နိုင်လို့ အစပိုင်းပဲတက်ပြီး ရေရှည် မတက်ဖြစ်ခဲ့ပါဘူး ဆရာ။ သင်တန်းတွေ Join ခဲ့ပေမဲ့ သေချာမလေ့လာခဲ့ပါဘူး ဆရာ။ အခြေခံတောင် နားမလည်သေးပါဘူး ဆရာ။', 'Programming ကို သေချာနားလည် တတ်ကျွမ်းဖို့ လိုအပ်နေလို့ပါ ဆရာ။', '2025-06-15', 2),
(32, 'Aye Nadi Kyaw', 'Myanmar', '1984-06-15', 'ayenadikyaw@gmail.com', '$2y$10$s7KNa08u6SJ.RYVBpTW//uHSzIincQThpS1CyFHRgmaXYW2CHvxV.', '@ayenadikyaw', '09428939200', 1, 'Yes', 'I would like to work in Japan. I would like to know Java Advanced lavel and want one by one class.', '2025-06-15', 2),
(33, 'Zaw Thura Soe', 'Myanmar', '2007-02-15', 'zawthurasoe@gmail.com', '$2y$10$waykhJsleh6cDFM1jNHTTe3tPZg3sBOz73tGYn1/YLqgSydyT0AOO', '@zatthuras', '09449536467', 1, 'Python Basic တွေ အကုန် သင်ဖူးပါတယ်ဗျ Jupyterနဲ့ပါ VsCode ကို မကျွမ်းကျင်သေးပါဘူး', 'စိတ်ဝင်စားလိုပါဗျ လုပ်နေရရင် မပျင်းတော့ဘူး GCSE ဖြေရင်လည်း Computer sci ယူမှာမလိုဗျ ခု လောလောဆယ် သင်နေတဲ့ Class က 4 လလောက် နားမှာမို တခြား အသစ်တွေ သင်ချင်လိုတက်တာပါဗျ', '2025-06-15', 2),
(34, 'Christopher', 'America', '1989-06-21', 'christopher@gmail.com', '$2y$10$OhER14Ugyj9VBCErMParAuvE5gWGgf9VRJ4xfaRx.yl2EiJwjD/Ty', '@christopher', '+14435099545', 1, 'null', 'null', '2025-06-15', 2),
(35, 'Bhone Wai Yan Moe', 'Vietnam', '2004-01-15', 'bhonewaiyan@gmail.com', '$2y$10$7dghyoC0UghyVcW56Yixbe6.Ik9XnYkx3HFR2a4XCkAAMkqWzQqU.', '@bhonewaiyan', '09420065505', 1, 'Programming fundamental with javaသင်ဖူးပါတယ်', 'ITနဲ့ပါတ်သတ်တဲ့ career နဲ့ ရှေ့ဆက်ချင်တာရယ် ဝါသနာပါတာရယ်ကြောင့်ပါ', '2025-06-15', 2),
(36, 'Myat Min Thu', 'Myanmar', '1995-02-15', 'myatminthu@gmail.com', '$2y$10$2qznObz36sEN8lHfTQb9n.6nMgbH31dHnc09f0wu3eKrSVQ0jec.q', '@myatminthu', '09974102510', 1, 'Programming ကို YouTubeက  အခုမှလေ့လာခါစပဲ ရှိပါသေးတယ် တလတောင်မပြည့်သေးပါ', 'ငယ်ငယ်ထဲက IT ကို အရမ်းစိတ်ဝင်စားခဲ့တာပါ 10 တန်းအောင်တော့လဲ အမှတ်မမှီခဲ့လို POL က  Cyber City တက်ချင်ခဲ့တဲ့အိမ်မက်က မပြည့်ဝခဲ့ပါဘူး ကိုယ့်ဘဝ ရဲ့ Carrier ကိုလဲ IT နယ်ပယ်ထဲမာပဲ ဖြတ်သန်းချင်လိုပါဗျ', '2025-06-15', 2),
(37, 'Hnin Kabyar Tun', 'Thailand', '2000-06-15', 'hninkabyartun@gmail.com', '$2y$10$CYwyfZIp5n6LnUXtQ6ePuOTZVIPj2GrIRDdBUw7exIM9ydVei.9RC', '@hninkabyartun', '+66949611269', 1, 'null', 'null', '2025-06-15', 2),
(38, 'YaMin', 'Japan', '1989-06-15', 'yamin@gmail.com', '$2y$10$vsWNAmQ5RffcO9HanJgB.OfN8tGesIr9Qadw7ge9LLCPTxM/ZgUBi', '@yamin', '+817041269937', 1, 'null', 'null', '2025-06-15', 2),
(39, 'Htoo Aung Cho', 'Korea', '1998-06-15', 'htooaungcho@gmail.com', '$2y$10$gBK9z6mGPKwxGAaa4DAVruCL6OU6iiqabvQnbzKGIRsPujByyu4Uq', '@HAungC', '+821073929907', 1, 'Yes', 'For school', '2025-06-15', 2),
(40, 'Moe Theigi Kyaw', 'Myanmar', '2005-06-15', 'moetheigikyaw@gmail.com', '$2y$10$OJ1TC7Q2pfCLbt3VTriMau5mH3gyK7lcyFIFpfVkdEXkYMykYq08G', '@moetheigikyaw', '09954872198', 1, 'yes', 'ဒဂုံတက္ကသိုလ်မှာ computer science majorဖြင့်  2nd yearကျောင်းသူဖြစ်ပြီး javaကို ပိုမိုသေချာနားလည်သဘောပေါက်စေရန်', '2025-06-15', 2),
(42, 'Naing Soe Ag', 'Thailand', '1997-06-15', 'naingsoeag@gmail.com', '$2y$10$SXnbkNJ0298I9SNTaI4gpOvBE89Gxn0NlshuDoKRt3PRqSW/8ZV9.', '@naingsoeag', '07091779006', 1, 'null', 'null', '2025-06-15', 2),
(43, 'Thiha Min Htin', 'Myanmar', '2000-06-15', 'thiha@gmail.com', '$2y$10$jf9PUFiEPDkedTpkB6ze1OwriRoisxDineT4rpKaF1qxalm3M7uE6', '@thiha', '09957316840', 1, 'null', 'null', '2025-06-15', 2),
(44, 'Aye Myat Mon', 'Myanmar', '2002-02-15', 'ayemyatmon@gmail.com', '$2y$10$blA40.5K7zAd1mwgHQIrqOdrHbIpYGaHCDjUt2B1XndMBrjoqYZkS', '@ayemyatmon', '09790341692', 1, 'I have learned the Programming Language', 'To become a professional programmer', '2025-06-15', 2),
(45, 'Khin LaPyae Won', 'Thailand', '2003-02-15', 'khinlapyawwon@gmail.com', '$2y$10$B3bLvK7Qcy1uBKh2cWdXuuc9NaVM3Dg1E/UzVsgb4cloMSIaNwrNi', '@khinlapyae', 'null', 1, 'Yes', 'Want to study Java Programming well', '2025-06-15', 2),
(46, 'YaMin Oo', 'Thailand', '2003-02-15', 'yaminoo@gmail.com', '$2y$10$.MUq0ju0Ls5t7U1Md9/5ze6nkTZQJ8/QvxTeqtHBH.3KZ.6MvJduC', '@yaminoo', 'null', 1, 'yes', 'Interested in Programming', '2025-06-15', 2),
(47, 'Shwe Zin', 'Myanmar', '1997-06-15', 'shwezin@gmail.com', '$2y$10$8auo.corWoFJSPQlfZxxcO23hR3Glvs1Qw7BA01JIUQf4yGesDFIS', '@shwezin', 'null', 1, 'null', 'null', '2025-06-15', 2),
(48, 'Sandah Aung', 'Thailand', '1977-06-15', 'sandahaung@gmail.com', '$2y$10$HR.zUV95M1Bq6QVAG0X7leVv8xsKa0uiPpoO47o4KP67NfyWRbX8C', '@sahdahaung', 'null', 1, 'yes', 'for job', '2025-06-15', 2),
(49, 'Min Thant Wai', 'Thailand', '1999-06-15', 'minthantwai@gmail.com', '$2y$10$AMFvWSeR7o45lnmRbQX5SuD8dWVihIXTKxLaQMlwUyfcpqDL8RAHm', '@minthantwait', 'null', 1, 'null', 'null', '2025-06-15', 2),
(50, 'Myat Min Thu', 'Singapore', '1986-02-15', 'myatminthu@gmail.com', '$2y$10$V4wkUiavP12GDxLl4mwb6ueYD4taIiBh2SbBs3X5IrBjKla.GhIfG', '@myatminthu2', '+65908773784', 1, 'a little', 'java programming ကို ပိုပီး နားလည်ပီး ရေးတတ်ချင်လိုပါ', '2025-06-15', 2),
(51, 'N Seng', 'Thailand', '1989-06-15', 'nseng@gmail.com', '$2y$10$mcsvHXfEUWudqgn6vTlWWeZ4V8/cyVnwmlTHIu4jprtDfHiWHCLiS', '@nseng', 'null', 1, 'null', 'null', '2025-06-15', 2),
(52, 'Thun Thiri Khin', 'Thailand', '2006-06-15', 'thunthirikhaing@gmail.com', '$2y$10$qZoJTPXLb6wOBk4xg36V1.3X23XywLeci5MDtKj3wFMcjAUli55O6', '@thunthirikhaing', '09769889233', 1, 'Has experienced in C and Java Programming', 'Want to be professional in JAva', '2025-06-15', 2),
(53, 'Okkar Min', 'Thailand', '2001-02-15', 'okkarmin@gmail.com', '$2y$10$j/1nEq9/FtUbZGBgkU7ISOL21TAM5Henx9BAXSoKBzjxMTBGzkl..', '@okkarmin', '0960564932', 1, 'No', 'To know python very well/ to know basics of programming and to prepare for exam', '2025-06-15', 2),
(54, 'Khon LaYaung Win', 'Myanmar', '2000-01-15', 'khonlayaungwin@gmail.com', '$2y$10$TVqvja46gxUgUZJgOcOMee0msFTSwhSTbqhUHiz/pMmrllORZFYFi', '@LeonLY7', 'null', 1, 'null', 'null', '2025-06-15', 2),
(55, 'Honey Aye', 'Japan', '1993-06-15', 'honeyaye@gmail.com', '$2y$10$sqNEs5hRgrypSDSDaJUeRetst7jnGf2atYh47mcdZCIO/zzQ96iH2', '@honeyaye', '+817084522233', 1, 'no', 'အလုပ်အတွက်အထောက်အကူပြုရန်', '2025-06-15', 2),
(56, 'Thet Oo Ag', 'Thailand', '2001-01-15', 'thetooag@gmail.com', '$2y$10$Vpx3/yDWeh1lgIXdjBdt1uvanp3SQ9VwXDFO63.E.JVy7bx9/jLlK', '@thetooag', '+959698949363', 1, 'no', 'for new career', '2025-06-15', 2),
...
(58, 'Htay Linn Kyaw', 'Myanmar', '2002-03-30', 'htaylinaung.wka@gmail.com', '$2y$10$yPlt5v5p4sL2Zw25d.Zr3eLtQ2zFHpkcXwqBtIRfb7AFsUEtYqMZe', '경수', '01084209991', 1, 'Yes', 'Python', '2025-06-18', 2),
(59, 'Wai Yan Htet Naing', 'Thailand', '1990-02-05', 'waiyanhtetnaing2020@gmail.com', '$2y$10$jRtQaxpYKjBJnA0EAFHVc.LIvbqBLH9DtNWEeVN2D9ItV0Oqp4nV.', 'RhythmR_Kee Nolan', '09420015800', 1, 'I haven\'t learned any programming languages before.I\'m someone interested in teachnology and just starting to learn the basics.', 'Firstly, I\'m interested in technology. Secondly, I want to have better career opportunities in the future. Thirdly, I\'d like to master it as a subject.', '2025-07-05', 2),
(60, 'San San Aye', 'Finland', '1990-02-06', 'sansanaye@gmail.com', '$2y$10$ZLhbolllVQ99ipE.z2oulOPm18/Kr8j5bo9dATegaWQi4b6GxWPha', '@sansanaye', '+358469653868', 1, 'Yes. Web Development', 'Want to be data scientist', '2025-07-06', 2),
(61, 'Yan Paing Oo', 'Thailand', '1990-04-06', 'yanpaingoo@gmail.com', '$2y$10$i26MAa4mniq0XUNYdA5k9e.wYr33FOQf18pqqBhuj9MTGZ0Z/701C', '@igzy_yan', '+66813151888', 1, 'No', 'I want to develop software and applications by myself.', '2025-07-06', 2),
(62, 'Ma Kyi Lin Thant', 'Myanmar', '2012-04-30', 'kylo.lalista2022@gmail.com', '$2y$10$L//LfCb.SiP4mD32Nn7I3essDbP70gdb000KunclzFGac4AxuHXxS', 'Elowen Hayes', '09650597711', 1, 'No', 'Interested in this course', '2025-07-06', 2),
(63, 'Tayaw Pai Ko', 'Myanmar', '2001-09-29', 'tayawpaiko379@gmail.com', '$2y$10$8aes276OUrz8sKowD8I8/.yY.nYKo2F/gYdv2EfjgoJu2P9Pbxmhq', 'Htayaw', '0948023200', 1, 'No', 'wanna switch my career', '2025-07-07', 2),
(65, 'Hein Min Htet', 'Myanmar', '2000-12-29', 'htetheinmin132@gmail.com', '$2y$10$/2GHuOlmDOJm5D7myegb3eOMsxdFz/PEzwBgDPGgSjQQxNHfln//.', '@hein25555', '09966731804', 1, 'နည်းနည်းတတ်ပါတယ်', 'Skillfulဖစ်အောင်လို့ပါ', '2025-07-12', 2),
(66, 'Yoon Yati Htut', 'Myanmar', '2004-06-11', 'yoon41105@gmail.com', '$2y$10$e5gmRvoz1Le5V62v9LEyFeW8YKSeGMzqCZpzMSeavSodAbwlSBzcG', 'Oliva Yoon', '09965559689', 1, 'HTML,CSS,PHP', 'I need knowledge.', '2025-07-12', 2),
(67, 'Ma Yamin Khaing', 'Myanmar', '2003-10-22', 'yaminkhaing2210@gmail.com', '$2y$10$IHTFnr/UPkkwc/IjTINyJOoO75kXl9Gk98XI7.hU2kvz0oaacexMO', 'Yamin_75', '09785567496', 1, 'web development', 'I want to do projects with my teacher first, and later I want to move into building web applications with java', '2025-07-12', 2),
(68, 'Swe Lae Nandar', 'Myanmar', '2005-04-15', 'swelaenandar0415@gmail.com', '$2y$10$bbWO8zAvGAXrIsItE/waWe0TRXd90AYoRYR0n9XqL.RpTKEDDMryi', 'swelae0415', '09672740155', 1, 'Web Development', 'I want to make projects with java', '2025-07-12', 2),
(69, 'Htay Linn Kyaw', 'Korea', '2002-03-30', 'htaylinaung.wka@gmail.com', '$2y$10$v9YEpfTdmzTfnsbbP8asZe/N7gQpCc9pijalh718ISBvjI7hvhUhO', '태활', '01084209991', 1, 'Web programming', 'Yes', '2025-07-15', 2),
(70, 'Yin Myat Theint', 'Japan', '1996-05-27', 'yinmyattheint.ymt@gmail.com', '$2y$10$cEjj9kkr13/c88FDVjmJn.HpHnbad3MksTd0Je.BZgVaXlG2VaKZm', 'Kaw kaw', '09977170596', 1, 'No', 'I watched some java basic  free video in YouTube.', '2025-07-19', 2),
(71, 'Leon', 'Thailand', '2007-10-13', 'mrlonely1711ken@gmail.com', '$2y$10$WA70dGqemsfFDTh2ptxnYed87R0R5JfaETT7u4v56jkxKrbxacNiq', '@Leowiet_ken', '0809234510', 1, 'I am Beginner', 'I\'m really passionate about writing codes and I interest in building website and implent them using the codes. So I hope this course would help me to build and level up my coding skills in web development.', '2025-07-25', 2),
(72, 'Khwann', 'Thailand', '2002-06-13', 'khawnn@gmail.com', '$2y$10$RkWuDMdNnLzU7kljkVEuaO.v09HZWrfmionOMWSD6RSslWiodYwum', '@Khawnn', '09762885331', 1, 'မရှိ', 'Uniတက်ရင် Computer Science တက်မှာဖြစ်တဲ့အတွက်ကြိုလေ့လာထားချင်လို', '2025-07-28', 2),
(73, 'Htin Aung Moe', 'Qatar', '1998-06-28', 'htinaungmoe@gmail.com', '$2y$10$zf6LnBCM2ztSaLy3Lkb5t.JXC9eczCihA57ImWMuSq.qfmNhOKDA.', '@HtinAungMoe', '+97433202360', 1, 'No', 'To change the career', '2025-07-28', 2),
(74, 'Zwe Lin Htut', 'Singapore', '1999-06-15', 'zwelinhtut@gmail.com', '$2y$10$td0jxyq1TXBJcYD6Jopg1e4dQf0y2YYg2LFeUt1bOEkb0dOTfUCnq', '@zwelinhtut', '09454450419', 1, 'basic Html', 'ဒီသင်တန်းက web development သမားတွေတွက်အကောင်းဆုံးဖြစ်ဖြစ်ပြီးကျွန်တောိ့ဘဝတက်လမ်းတွက်ပါအထောက်ကူဖြစ်နိုင်တာမိုလိုပါ', '2025-07-28', 2),
(75, 'Hsu Myat San', 'America', '2005-02-28', 'hsumyatsan@gmail.com', '$2y$10$aL.T6cBQbibd.U0XsVYYo.FabzzWYu396DPCQPC0R7MO7QZhQ8Hgm', '@hsumyatsan', '440-876-4294', 1, 'ပထမဦးဆုံးအကြိမ်စလေ့လာမှာပါရှင့်', 'Website တစ်ခုကို ကိုယ့်ရဲ့ စိတ်ကူးစိတ်သန်းအတိုင်း အကောင်အထည်ဖော်ချင်တာကြောင့်ပါ', '2025-07-28', 2),
(76, 'Mya Thet Mon', 'Singapore', '2005-01-12', 'myathetmon@gmai.com', '$2y$10$PYRVAofOvUv9hpewd/mcx.4jSsR47bRr5w1.bIOiFSRY16eQgoBr.', '@myatthetmon', '00000000001', 1, 'Yes', 'To be professional python', '2025-07-28', 2),
(77, 'Hnin Nu', 'Singapore', '1992-06-28', 'hninnu@gmail.com', '$2y$10$kCoGWiKYEOjvHVLbm9.3xORUFj56pzT8vJ9EMTuDO0LUmj8LUZJr2', '@hninnu', '98577726', 1, 'Yes', 'interested in backend software developer', '2025-07-28', 2),
(78, 'AUNG AUNG LWIN', 'Myanmar', '1999-06-20', 'aungaunglwin2061999@gmail.com', '$2y$10$yRbfO7uA0kX2GM4s4XWdq.lzbKj4VaAY60bkb2fNl.g5tkO9.aLOO', 'AUNG AUNG LWIN', '090-8328-7025', 1, 'Java', 'Want to know Java to Advance level', '2025-08-03', 1),
(80, 'Linn Lett Eain', 'Myanmar', '2025-12-17', 'linnletteain7@gmail.com', '$2y$10$FI3V35uejZJ4vHvA4ea8hOoKtK89syphmXOK8rrdEFtdkcD956q0q', 'linnlett_7', '09 892474744', 1, 'No,I have never studied yet.', 'I would like to improve programming and learn to know more about what fields I truly interested in and knowfurther horizons in IT industry', '2025-10-06', 1),
(82, 'Riki', 'Myanmar', '2000-09-04', 'zin164268@gmail.com', '$2y$10$3VE19iOUICaIDxmi5At1gupd1idH5tFJABL/DHpCbgkeiNvFCxfYq', '@riki983', '09964899660', 1, 'Not yet this is my first time', 'I want learn programming', '2025-11-10', 2),
(83, 'Thet Htar San', 'Korea', '2002-11-10', 'thetsan1102@gmail.com', '$2y$10$Ffo6CCm8zAKWKjnJiuqKZeRxxUk0SwsTGrjl33jpe2yYZC29K99Ti', '@fiona1102', '09975723762', 1, 'Python', 'To learn more about how website works', '2025-11-21', 2),
(84, 'Ash', 'Ireland', '2000-01-29', 'htetookhin20@gmail.com', '$2y$10$eAZ7KMpDvkl4sQxwB6K0AeYNhRWbl4inwBaWoB/YTkiBMGHfj.2d6', '@aitchezone', '0634901306', 1, 'Nope', 'To get improved', '2025-11-26', 2),
(87, 'Pann Moh Moh Phyu', 'Myanmar', '2002-04-25', 'pannmohmohphyu@gmail.com', '$2y$10$fUWexNpAlxnt6b2oHgkjh.Bemb0eX2sT1D9N3dGDnFQW.8RV0Z02W', 'jill254_02', '07044808145', 1, 'Nope', 'Career up', '2025-12-29', 2),
(89, 'Hla Bhone Han', 'Singapore', '2004-01-15', 'hlaphonehan66@gmail.com', '$2y$10$wiwZnLkejSKkVGOJvy9ql.nTmGtbxvnOd.Yu9.PnyjWJOTSG6ztL6', 'Hla Bhone Han', '+6585856697', 1, 'C Programming', 'I want to train C Programming for my piscine.', '2026-01-02', 2),
(91, 'MAY YAMONE PHOO', 'Japan', '1996-05-09', 'phoo966phoo@gmail.com', '$2y$10$UxrflXQ9zwPZDrJydRVJeOqvGnOmD/mwBo2kE7bvyq8wQM543q6E2', 'phoo22phoo', '+818013793610', 1, 'No, I have never studied.', 'To change the career', '2026-01-12', 2),
(93, 'Kyaw Naing Win', 'Myanmar', '2002-04-09', 'knw767@gmail.com', '$2y$10$NyLIhhgXWN9yrUafDmF/HOxW1OAjSoeHd6Hbq519B8OuOG9GZbCS2', 'Kyaw Naing Win', '09689976087', 1, 'no', 'To prepare for my university', '2026-02-04', 1);
...
(26, 'ဆရာနဲ့သင်ရတာတော်တော်အားရပါတယ် ပြီးတော့ ဆရာကနားမလည်တဲ့စာတွေကိုလဲသေသေချာချာပြန်ရှင်းပြပါတယ်အရင်တုန်းကကျွန်တော် computer programming skill ကတော်တော်ဆိုးပါတယ် ဆိုးတယ်ဆိုလုပ်ကိုမလုပ်တတ်တာပါခုတော့ဆရာ့ကျေးဇူးနဲ့ကျွမ်းကျွမ်းကျင်ကျင်လုပ်တတ်သွားပါပြီဒါကြောင့်ဆရာ့ကိုတော်တော်ကျေးဇူးတင်ပါတယ်ဆရာရေ', 1, 30, 1),
...
--
-- Indexes for table `learningtype`
--
ALTER TABLE `learningtype`
  ADD PRIMARY KEY (`typeID`);

--
-- Indexes for table `lecture_link`
--
ALTER TABLE `lecture_link`
...
--
ALTER TABLE `batch`
  MODIFY `batchID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `file`
  MODIFY `fileID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `learningtype`
--
ALTER TABLE `learningtype`
  MODIFY `typeID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `lecture_link`
--
ALTER TABLE `lecture_link`
  MODIFY `linkID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `oscord_coursedetail`
  MODIFY `coursedetailID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;

--
-- AUTO_INCREMENT for table `oscord_instructor`
--
ALTER TABLE `oscord_instructor`
  MODIFY `instructorID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `oscord_instructorxcourse`
--
ALTER TABLE `oscord_instructorxcourse`
  MODIFY `instrucorxcourseID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `oscord_student`
--
ALTER TABLE `oscord_student`
  MODIFY `studentID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
...
--
ALTER TABLE `oscord_studentxcourse`
  MODIFY `studentxcourseID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
...
--
ALTER TABLE `batch`
  ADD CONSTRAINT `batch_ibfk_1` FOREIGN KEY (`courseID`) REFERENCES `oscord_course` (`courseID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
-- Constraints for table `lecture_link`
--
ALTER TABLE `lecture_link`
  ADD CONSTRAINT `lecture_link_ibfk_1` FOREIGN KEY (`courseID`) REFERENCES `oscord_course` (`courseID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
-- Constraints for table `oscord_student`
--
ALTER TABLE `oscord_student`
  ADD CONSTRAINT `oscord_student_ibfk_1` FOREIGN KEY (`learningType`) REFERENCES `learningtype` (`typeID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
