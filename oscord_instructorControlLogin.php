...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare and execute query to check instructor credentials
    $query = "SELECT * FROM oscord_instructor WHERE instructorEmail = ? AND instructorPin = ?";
    ...
    if ($result->num_rows == 1) {
        ...
        // Verify password
        if (password_verify($password, $instructor['instructorPassword'])) {
            // Check if instructor is approved
            if ($instructor['instructorApprove'] == 1) {
                // Set session variables
                $_SESSION['instructor_id'] = $instructor['instructorID'];
                $_SESSION['instructor_name'] = $instructor['instructorName'];
                
                // Set success message and redirect
                $message = 'Login Successful';
                $redirect = "admin_dashboard.php?instructorID=" . urlencode($instructor['instructorID']);
            } else {
                // Set error message and redirect
                $message = 'Instructor not approved';
                $redirect = "oscord_home.php?error=Instructor not approved";
            }
        } else {
            // Set error message and redirect
...
<head>
    ...
    <title>Instructor Login - Oscord</title>
...
<body>
    ...
    <div class="cyber-card">
        <h2 class="text-4xl font-bold text-white mb-8 text-center tracking-wider">Instructor Login</h2>
