...
<style>
    ...
    .course-title {
        ...
        font-weight: 700;
        margin-bottom: 20px;
        text-shadow: 0 0 10px rgba(63, 216, 246, 0.7);
    }
    ...
    .course-image-container {
        ...
        overflow: hidden;
        margin-bottom: 30px;
        box-shadow: 0 0 25px rgba(34, 224, 249, 0.5);
    }
    ...
    .details-content-wrapper::-webkit-scrollbar-thumb {
        background: linear-gradient(180deg, #00f2ff, #00f2ff);
        border-radius: 10px;
    }
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="course-meta-box">
                            ...
                            <div class="meta-item">
                                ...
                                <span><b>Zoom Group Class : </b> <?= number_format($courseFee*0.6)?> MMK</span>
                            </div>
                            ...
                            <div class="meta-item">
                                ...
                                <span><b> Face to Face in Bangkok : </b><?= number_format($courseFee*2)?> MMK</span>
                            </div>
