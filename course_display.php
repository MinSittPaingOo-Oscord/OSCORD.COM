...
<head>
    ...
    <!-- Bootstrap for utilities (like container) and columns -->
    ...
    <style>
        ...
        * {
        ...
        .swiper {
            width: 100%;
            padding: 20px 0;
            /* Allow space for the scrollbar at the bottom */
            padding-bottom: 40px;
        }

        /* SWIPER SCROLLBAR ENHANCEMENTS */
        /* .swiper-scrollbar {
        ...
        /* Custom Arrow Icons (Optional: Use Font Awesome for better appearance) */
        /*  */
        /* .swiper-scrollbar-drag{
    display:none;
}
...
<body>
    <div class="container" id="main-course-container">
        ...
        <div class="swiper course-slider">
            ...
            <!-- Swiper Scrollbar and Navigation -->
